...
//Box four Front End Projects
  ...
  document.addEventListener('DOMContentLoaded', function() {
    const FrontEndContainers = document.getElementById('FrontEndBox');
    const modalContainer = document.getElementById('modalContainer');
    const modalImage = document.getElementById('modalImage');
    ...
    const names = {
      person1: {
        ...
        date: 'May 16, 2023',
        image: "./images/random.png",
        websiteLink : "https://github.com/jilmercortez07/jilmercortez07.github.io",
      },
      person2: {
        nombre: 'pepe',
        property: 'ok',
    ...
    for (let key in names) {
      const boxWrapper = document.createElement('div');
      boxWrapper.classList.add('box-wrapper');
      FrontEndContainers.appendChild(boxWrapper);
      ...
      websiteLink.classList.add('labelThree');
      websiteLink.href = names[key].websiteLink;
      websiteLink.textContent = 'Github: ' + names[key].websiteLink;
      websiteLink.target = '_blank';
      boxWrapper.appendChild(websiteLink)
